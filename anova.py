...
## Load in the data with `read_csv()` then I pass the URL in which the data can be found. adapted from https://www.datacamp.com/community/tutorials/exploratory-data-analysis-python
